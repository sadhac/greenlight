...
module Greenlight
  class Application < Rails::Application
    ...
    config.help_url = ENV["HELP_URL"].nil? ? "https://instantmeetings.co.za/meet" : ENV["HELP_URL"]
    ...
    config.branding_image_default = "https://instantmeetings.co.za/images/logoIM.png"
